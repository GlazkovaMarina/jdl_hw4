...
public class Employee {
    ...
    public Employee(String name, Integer workExperience, Long number) {
        this.name = name;
        this.workExperience = workExperience;
        this.number = new ArrayList<>();
        this.number.add(number);
        this.personnelNumber = hashCode();
    }
    public Employee(String name, Integer workExperience, String number) {
        this.name = name;
        this.workExperience = workExperience;
        this.number = new ArrayList<>();
        if (number.indexOf(0) == '+')
